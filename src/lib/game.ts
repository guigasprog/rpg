...
export interface SubclassItem {
  ...
  dadoEfeito?: string; // rolagem de efeito (ex.: "1d6")
  baseEfeito?: number;
  recurso?: string; // "PV" | "SAN"
  especialista?: string; // subclasse especialista
...
export const SUBCLASSES: Record<string, SubclassInfo[]> = {
  ...
  ESPECIALISTA: [
    ...
    { key: "medico", classe: "ESPECIALISTA", label: "Médico", descricao: "Segura a vida com as próprias mãos.", pvPorNivel: 1, sanPorNivel: 1, habilidades: ["Estabiliza um personagem em PV negativo.", "Diagnostica males e venenos."], item: { nome: "Kit Médico", dano: "", qtd: 1, usos: 6, dadoEfeito: "1d6", baseEfeito: 3, recurso: "PV", especialista: "medico", bonusEspecialista: 2, usosSemEspecialista: 5 } },
  ...
  OCULTISTA: [
    ...
    { key: "exorcista", classe: "OCULTISTA", label: "Exorcista", descricao: "Empurra o Irreal de volta.", sanPorNivel: 1, habilidades: ["Bane entidades menores.", "Reconhece possessão à primeira vista."], item: { nome: "Água Benta", dano: "", qtd: 3, usos: 5, dadoEfeito: "1d4", baseEfeito: 2, recurso: "SAN", especialista: "exorcista", bonusEspecialista: 2, usosSemEspecialista: 3 } },
